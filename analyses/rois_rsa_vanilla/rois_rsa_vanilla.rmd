...
if (measure.i == "corr") {
  ...
  vanil.1tr1knot.pc50 <- atanh(vanil.1tr1knot.pc50)  ## r to z
  vanil.2tr1knot.pc50 <- atanh(vanil.2tr1knot.pc50)

} else if (measure.i %in% c("eucl", "neuc")) {

  ## negate (for comparison to correlation)

  vanil.1tr1knot.pc50 <- -vanil.1tr1knot.pc50
  vanil.2tr1knot.pc50 <- -vanil.2tr1knot.pc50
